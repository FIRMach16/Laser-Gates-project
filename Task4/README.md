...
- 27/11/2025 : 
    ...
    - For power i will chose a LiPo 3.7v for it's ability to be recharged and it's availability, and personnaly i belive it's good choice because it will give me a good reference for fture projects.
    ...
    - I decided add audio to the start gate to simulate the "On your marks, set ,GO!" of a real race as this will allow an athlte to measure have his run time+ his reaction time which will give a time which is close to the reality of a competition.
